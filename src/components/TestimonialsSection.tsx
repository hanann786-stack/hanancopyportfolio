...
const TestimonialsSection = () => (
  <section id="clients" className="testi">
    ...
    <div className="testi-row-1">
      <div>
        <figure className="testi-frame">
          <img src={marcusImg.url} alt="Client message from Marcus Webb" loading="lazy" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
        </figure>
      ...
      <div className="testi-right">
        ...
        <div>
          <figure className="testi-frame testi-frame-sm">
            <img src={sarahImg.url} alt="Client message from Sarah Chen" loading="lazy" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
          </figure>
    ...
    <div className="testi-row-2">
      <div>
        <figure className="testi-frame testi-frame-sm">
          <img src={triptaImg.url} alt="Client message from Tripta Sports" loading="lazy" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
        </figure>
      ...
      <div>
        <figure className="testi-frame testi-frame-sm">
          <img src={elenaImg.url} alt="Client message from Elena Rossi" loading="lazy" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
        </figure>
