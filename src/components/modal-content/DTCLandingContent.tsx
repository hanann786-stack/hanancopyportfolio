...
const DTCLandingContent = () => (
  <div>
    ...
    <div className="text-center mb-2">
      ...
      <span className="inline-block bg-[#C1121F] text-white font-accent text-[12px] uppercase tracking-[0.1em] px-8 py-3.5 rounded-sm cursor-pointer hover:bg-[#a30f1a] transition-colors">
    ...
    <div className="mb-2">
      ...
      <h3 className="font-display text-2xl md:text-3xl text-white-headline mb-5 tracking-[-0.02em]">
        You've Tried Everything. Your Skin Still Isn't <span className="text-[#C1121F] font-bold">Listening.</span>
      </h3>
    ...
    <div className="mb-2">
      ...
      <p className="font-display text-2xl text-gold" style={{ textShadow: '0 0 20px rgba(201,168,76,0.4)' }}>
        Today: $89
      </p>
    </div>
