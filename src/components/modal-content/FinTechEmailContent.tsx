  ...
  return (
    <div className="border border-[hsla(43,52%,54%,0.12)] rounded-sm overflow-hidden">
      ...
      >
        ...
        <span className="font-body text-sm text-[#B8703F] font-semibold truncate">
        ...
        {isOpen && (
          ...
          >
            <div className="px-5 pb-6 pt-2 border-t border-[hsla(43,52%,54%,0.08)]">
              ...
              {email.cta && (
                <div className="mt-6">
                  <span className="inline-block bg-[#B8703F] text-white font-accent text-[12px] uppercase tracking-[0.1em] px-6 py-3 rounded-sm">
                    {email.cta}
                  </span>
                </div>
              )}
